...
![](https://cdn.ithhx.cn/img-blog/20210909095251.png)

> 在master上创建分支（创建分支由组长创建）

![](https://cdn.ithhx.cn/img-blog/20210909095530.png)

> 正常迭代创建（dev/对应的版本号+qa环境）例：dev/vCOA-qa4

![](https://cdn.ithhx.cn/img-blog/20210909135904.png)

> 紧急迭代创建（feature/对应的版本号+qa环境+紧急需求ID号）例：feature/vCOA-qa4-1004332

![](https://cdn.ithhx.cn/img-blog/20210909100459.png)

> 紧急需求ID号

![](https://cdn.ithhx.cn/img-blog/20210909100655.png)

> 修复分支创建（hotfix/对应的功能名称）例：hotfix/order

![](https://cdn.ithhx.cn/img-blog/20210909101446.png)
...
![](https://cdn.ithhx.cn/img-blog/20210909102401.png)

第二步、将当前开发分支合并到release环境（由对应的模块负责人合并）例：Merge dev/vCOA-qa4 into release

![](https://cdn.ithhx.cn/img-blog/20210909135312.png)

第三步、将当前开发分支合并到master（由上线的负责人合并）例：Merge dev/vCOA-qa4 into master

![](https://cdn.ithhx.cn/img-blog/20210909135406.png)
